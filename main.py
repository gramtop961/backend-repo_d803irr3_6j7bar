...
app = FastAPI(title="Comfortably Chaotic Co API")
...
@app.get("/")
def read_root():
    return {"message": "Comfortably Chaotic Co API running"}
...
def subscribe(subscriber: Subscriber):
    """Create a subscriber document in MongoDB"""
    try:
        from database import create_document

        insert_id = create_document("subscriber", subscriber)
        return {
            "status": "ok",
